...
set QTPATH=C:\Qt\5.8\msvc2015_64
...
set NODE_NAME=windows8-vc2015-x64
set RTM_ROOT=%WORKSPACE%10_openrtm-cxx-build-win64\label\%NODE_NAME%\OpenRTM-aist\
...
set ODE_DIRECTORIY=C:\workspace\ode-0.13_x64
set QWT_DIRECTORIY=C:\workspace\Qwt_x64
set BOOST_DIRECTORIY=C:\workspace\boost_1_49_0
set PACKAGE_DIRECTORIY=C:\workspace\site-packages
set LUA_DEV=C:\workspace\lua-5.1.5_Win64_dll14_lib
