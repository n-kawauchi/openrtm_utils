...
if not defined TOOL_VERSION set TOOL_VERSION=020
if not defined TARGET_VERSION set TARGET_VERSION=0.2.0.0

if not defined ARCH set ARCH=x86
if not defined PYTHON_DIR set PYTHON_DIR=C:\Python27

set PKG_NAME=SettingRTSystem
...
xcopy /y/q ComponentsStart_dir.wxsctrl utils\SettingRTSystem\ComponentsStart\
xcopy /y/q create_folder_dir.wxsctrl utils\SettingRTSystem\ComponentsStart\
