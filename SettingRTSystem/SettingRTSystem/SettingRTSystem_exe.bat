...
set PATH=%SettingRTSystemPath%\DLL;%PATH%;%RTM_ROOT%bin\%VC_VERSION%;%RTM_ROOT%omniORB\%OMNI_VERSION%_%VC_VERSION%\bin\x86_win32;%OpenCV_DIR%\%ARCH%\%VC_VERSION%\bin;C:\Python27;C:\Python27\Scripts;
set TOOLEXE=TRUE
set QT_PLUGIN_PATH=%SettingRTSystemPath%\DLL;
