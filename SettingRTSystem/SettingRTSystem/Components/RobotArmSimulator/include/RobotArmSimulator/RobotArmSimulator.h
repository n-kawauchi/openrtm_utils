...
#ifndef ROBOTARMSIMULATOR_H
#define ROBOTARMSIMULATOR_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  RobotArmSimulator(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void RobotArmSimulatorInit(RTC::Manager* manager);
};

#endif // ROBOTARMSIMULATOR_H
