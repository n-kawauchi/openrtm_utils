...
#ifndef Crawl_Gait_Controller_H
#define Crawl_Gait_Controller_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  Crawl_Gait_Controller(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void Crawl_Gait_ControllerInit(RTC::Manager* manager);
};

#endif // Crawl_Gait_Controller_H
