// -*- C++ -*-
/*!
 * @file  Crawl_Gait_Controller.cpp
 * @brief Crawl Walk Controller Component
 * @date $Date$
 *
...
#include "Crawl_Gait_Controller.h"

// Module specification
// <rtc-template block="module_spec">
static const char* crawl_gait_controller_spec[] =
  {
    "implementation_id", "Crawl_Gait_Controller",
    "type_name",         "Crawl_Gait_Controller",
    "description",       "Crawl Walk Controller Component",
    "version",           "1.0.0",
    "vendor",            "AIST",
    "category",          "Controller",
	...
	"conf.default.min_stability_margin", "-0.001",
 ...
 */
Crawl_Gait_Controller::Crawl_Gait_Controller(RTC::Manager* manager)
 ...
 * @brief destructor
 */
Crawl_Gait_Controller::~Crawl_Gait_Controller()
{
}



RTC::ReturnCode_t Crawl_Gait_Controller::onInitialize()
{
	...
	bindParameter("min_stability_margin", m_min_stability_margin, "-0.001");
...
RTC::ReturnCode_t Crawl_Gait_Controller::onFinalize()
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t Crawl_Gait_Controller::onStartup(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t Crawl_Gait_Controller::onShutdown(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t Crawl_Gait_Controller::onActivated(RTC::UniqueId ec_id)
{
...
RTC::ReturnCode_t Crawl_Gait_Controller::onDeactivated(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t Crawl_Gait_Controller::onExecute(RTC::UniqueId ec_id)
{
	...
	robot.crawl_gait(m_target_velocity.data.vx, m_target_velocity.data.vy, m_target_velocity.data.va, m_stride);
	...
	//std::cout << m_target_velocity.data.vx << "\t" << m_target_velocity.data.vy << "\t" << m_target_velocity.data.va << std::endl;
	/*for (int i = 0; i < 4; i++)
	{
		for (int j = 0; j < 3;j++)
		{
			std::cout<< i << "\t" << j << "\t" << robot.legs[i].current_pos(j) << std::endl;
		}
	}*/
...
RTC::ReturnCode_t Crawl_Gait_Controller::onAborting(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t Crawl_Gait_Controller::onError(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t Crawl_Gait_Controller::onReset(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t Crawl_Gait_Controller::onStateUpdate(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t Crawl_Gait_Controller::onRateChanged(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
...
extern "C"
{
  ...
  void Crawl_Gait_ControllerInit(RTC::Manager* manager)
  {
	  coil::Properties profile(crawl_gait_controller_spec);
    manager->registerFactory(profile,
                             RTC::Create<Crawl_Gait_Controller>,
                             RTC::Delete<Crawl_Gait_Controller>);
  }
