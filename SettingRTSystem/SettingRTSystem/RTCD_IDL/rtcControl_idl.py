# Python stubs generated by omniidl from rtcControl.idl
...
#
__name__ = "rtcControl"
_0_rtcControl = omniORB.openModule("rtcControl", r"rtcControl.idl")
_0_rtcControl__POA = omniORB.openModule("rtcControl__POA", r"rtcControl.idl")
...
class _objref_RTCDataInterface (CORBA.Object):
    ...
    def getRTC(self, *args):
        return self._obj.invoke("getRTC", _0_rtcControl.RTCDataInterface._d_getRTC, args)

    def createComp(self, *args):
        return self._obj.invoke("createComp", _0_rtcControl.RTCDataInterface._d_createComp, args)

    def removeComp(self, *args):
        return self._obj.invoke("removeComp", _0_rtcControl.RTCDataInterface._d_removeComp, args)

    def getCompList(self, *args):
        return self._obj.invoke("getCompList", _0_rtcControl.RTCDataInterface._d_getCompList, args)
